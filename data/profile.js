...
•	Installation and configuration of network devices (Cisco, Mikrotik, and Fortinet) and network monitoring tools (Nagios, Cacti, MRTG)`,
  ...
  certifications: [
    ...
    {
      desc: `<strong>Kubernetes Certified (KCNA)</strong> by <strong>Udemy IN PROGRESS</strong> (<a target='_blank' rel='noreferrer' href='https://github.com/psyunix/resume/blob/main/data/certs/RHCSA-milan_cvetic_udemy.pdf'>KCNA</a>)`,
      date: "2025",
    },
