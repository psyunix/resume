const profileData = {
  ...
  skills: [
    ...
    {
      title: "Others",
      value: "Git, CI/CD, Terraform, Ansible, Grafana and Prometheus, Backup and Data management (10+ years), VMware and Cloud technologies (10+ years), Security (10+ years), Monitoring systems (10+ years), Network (10+ years), Python/Perl/Bash/PowerShell scripting (10+ years), DevOps (5+ years)",
    },
  ],
  experiences: [
    {
...
•	Maintaining virtual Linux servers in a VMware environment with Unix/FreeBSD servers for various purposes
...
•	Analyze and resolve diagnostic problems on Sun, HP-UX, and FreeBSD systems.
...
•	Installation and configuration of network devices (Cisco, Mikrotik, and Fortinet) and network monitoring tools (Nagios, Cacti, MRTG)`,
      ],
    },
  ],
  projects: [
  ...
  certifications: [
    ...
    {
      desc: `<strong>RHCSA</strong> SS by <strong>Udemy</strong> (<a target='_blank' rel='noreferrer' href='https://github.com/psyunix/resume/blob/main/data/certs/RHCSA-milan_cvetic_udemy.pdf'>RHCSA</a>)`,
      date: "2024",
    },
